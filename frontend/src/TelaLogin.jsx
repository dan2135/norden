  ...
  return <main className="login-pagina">
    ...
    <section className="login-area">
      <form className="login-card" onSubmit={enviar}>
        ...
        {modo==='cadastro' && <label>Ramo de atividade<select value={form.segmento} onChange={e=>setForm({...form,segmento:e.target.value})}><option value="outros">Outros ramos</option><option value="serralheria">Serralheria e solda</option><option value="comercio">Comércio</option><option value="servicos">Prestação de serviços</option><option value="marcenaria">Marcenaria</option></select></label>}
