  ...
  return <main className="login-pagina">
    ...
    <section className="login-area">
      <form className="login-card" onSubmit={enviar}>
        ...
        <p className="login-ajuda">{modo==='confirmar'?'Aguarde enquanto verificamos seu e-mail.':modo==='reenviar'?'Informe o e-mail usado no cadastro para solicitar outro link.':modo==='esqueci'?'Enviaremos um link de recuperação ao e-mail cadastrado.':modo==='redefinir'?'Use pelo menos 10 caracteres.':primeiroAcesso?'Você será o proprietário da marcenaria principal.':modo==='cadastro'?'Cadastre sua empresa e confirme o e-mail para entrar.':'Entre para acessar seus projetos e orçamentos.'}</p>
