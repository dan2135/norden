...
export const paginasInstitucionais = {
  ...
  privacidade: { titulo: 'Política de privacidade', blocos: [
    ...
    ['Cookies e preferências', 'Usamos um cookie essencial para manter sua sessão segura enquanto você estiver conectado. Você pode aceitar ou recusar o armazenamento opcional da preferência de tema e da última empresa selecionada neste dispositivo. A Norden não usa cookies de publicidade.'],
