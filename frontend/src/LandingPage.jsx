...
const beneficios = [
  ['01', 'Cada conversa vira contexto.', 'A Suzy ajuda a coletar o pedido pelo WhatsApp. Você acompanha o histórico sem começar do zero a cada conversa.', 'WhatsApp com memória'],
    ...
    <main id="conteudo">
      <section className="lp-hero lp-container">
        <div className="lp-hero-copy"><p className="lp-eyebrow"><span className="lp-mini-icon" aria-hidden="true">✳</span> MENOS TAREFAS SOLTAS. MAIS POSSIBILIDADES.</p>
          ...
          <p className="lp-intro">WhatsApp, clientes e orçamentos em um só lugar. Com a Suzy ao seu lado, cada conversa ganha um próximo passo.</p>
      ...
      <section className="lp-plans-section" id="planos"><div className="lp-container"><div className="lp-section-heading centered"><p className="lp-eyebrow">COMECE NO SEU TEMPO</p><h2>Primeiro, conheça.<br/>Depois, escolha continuar.</h2><p>Uma proposta simples para experimentar a plataforma e levar mais organização para sua empresa.</p></div><div className="lp-plan-grid">
        <article className="lp-plan"><span className="lp-plan-tag">PARA EXPERIMENTAR</span><h3>15 dias grátis</h3><p>Conheça uma nova forma de organizar o negócio.</p><div className="lp-price">R$ 0 <span>/ primeiros 15 dias</span></div><ul className="lp-checks"><Check>Conheça o painel e a Suzy</Check><Check>Explore clientes, projetos e orçamentos</Check><Check>Avalie se faz sentido para sua rotina</Check></ul><a className="lp-button lp-outline" href={registrar}>Criar meu cadastro <span aria-hidden="true">↗</span></a></article>
        <article className="lp-plan lp-plan-paid"><span className="lp-plan-tag">PREÇO INICIAL</span><h3>Plano profissional</h3><p>Um próximo passo para a gestão do seu negócio.</p><div className="lp-price">R$ 110 <span>/ mês após o período gratuito</span></div><ul className="lp-checks"><Check>Continuidade após o período de experiência</Check><Check>Condições apresentadas antes da contratação</Check><Check>Ativação mediante sua escolha</Check></ul><a className="lp-button lp-white" href={registrar}>Conhecer a plataforma <span aria-hidden="true">↗</span></a></article>
