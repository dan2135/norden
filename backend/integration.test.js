/**
 * Testes de regressão: API: atendimento, pendências persistidas, logs, isolamento, falhas e rollback. Casos com TEST_DATABASE precisam de banco de testes isolado; não habilitar no banco de produção.
 */
